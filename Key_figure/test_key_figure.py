...
class TestAnalysisDatasetDataframe(unittest.TestCase):
    ...
    def test_sample_data_structure_and_dtypes(self):
        ...
        #checks all valyes within the given column
    ...
    #checks whether all datatypes are correct
